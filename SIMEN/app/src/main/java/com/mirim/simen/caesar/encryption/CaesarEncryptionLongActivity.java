...
import com.mirim.simen.caesar.decode.CaesarDecodeLongActivity;
import com.mirim.simen.caesar.decode.CaesarDecodeShortActivity;

public class CaesarEncryptionLongActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_caesar_encryption_long);
                ...
                switch(v.getId())
                {
                    ...
                    case R.id.button_copy:
                        if(textAfter.getText().toString().length() > 0) {
                            ...
                            Toast.makeText(CaesarEncryptionLongActivity.this, "암호문이 복사되었습니다.", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(CaesarEncryptionLongActivity.this, "암호화된 문장이 없습니다.", Toast.LENGTH_SHORT).show();
                        }
                        break;

                    case R.id.button_reverse:
                        if(textAfter.getText().toString().length() > 0) {
                            Intent intent = new Intent(CaesarEncryptionLongActivity.this, CaesarDecodeLongActivity.class);
    ...
    public void Caesar() {
        ...
        if(textBefore.getText().toString().length() > 0) {
            if(textKey.getText().toString().length() > 0) {
                ...
                Toast.makeText(CaesarEncryptionLongActivity.this, "암호화를 완료하였습니다.", Toast.LENGTH_SHORT).show();
