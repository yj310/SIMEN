                ...
                switch(v.getId())
                {
                    ...
                    case R.id.button_copy:
                        if(textAfter.getText().toString().length() > 0) {
                            ...
                            Toast.makeText(CaesarDecodeLongEncryKeyActivity.this, "복호문이 복사되었습니다.", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(CaesarDecodeLongEncryKeyActivity.this, "복호화된 문장이 없습니다.", Toast.LENGTH_SHORT).show();
                        }
                        break;

                    case R.id.button_reverse:
                        if(textAfter.getText().toString().length() > 0) {
                            Intent intent = new Intent(CaesarDecodeLongEncryKeyActivity.this, CaesarEncryptionLongActivity.class);
    ...
    public void Caesar() {
        ...
        if(textBefore.getText().toString().length() > 0) {
            if(textKey.getText().toString().length() > 0) {
                ...
                Toast.makeText(CaesarDecodeLongEncryKeyActivity.this, "복호화를 완료하였습니다.", Toast.LENGTH_SHORT).show();
