...
import com.mirim.simen.caesar.encryption.CaesarEncryptionLongActivity;
import com.mirim.simen.caesar.encryption.CaesarEncryptionShortActivity;

public class CaesarDecodeLongActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_caesar_decode_long);
                ...
                switch(v.getId())
                {
                    ...
                    case R.id.button_copy:
                        if(textAfter.getText().toString().length() > 0) {
                            ...
                            Toast.makeText(CaesarDecodeLongActivity.this, "복호문이 복사되었습니다.", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(CaesarDecodeLongActivity.this, "복호화된 문장이 없습니다.", Toast.LENGTH_SHORT).show();
                        }
                        break;

                    case R.id.button_reverse:
                        if(textAfter.getText().toString().length() > 0) {
                            Intent intent = new Intent(CaesarDecodeLongActivity.this, CaesarEncryptionLongActivity.class);
                    ...
                    case R.id.button_another_key:
                        Intent intent = new Intent(CaesarDecodeLongActivity.this, CaesarDecodeLongEncryKeyActivity.class);
    ...
    public void Caesar() {
        ...
        if(textBefore.getText().toString().length() > 0) {
            if(textKey.getText().toString().length() > 0) {
                ...
                Toast.makeText(CaesarDecodeLongActivity.this, "복호화를 완료하였습니다.", Toast.LENGTH_SHORT).show();

            } else {
                Toast.makeText(this, "복호키를 입력하십시오.", Toast.LENGTH_SHORT).show();
            }
        } else {
